...
class TestFriends < MiniTest::Test
  ...
  def test_persons_favourite_tv_show
  ...
  def test_check_particular_snack
    result = get_snack(@person3, "spinach")
  ...
  def test_add_new_friend
    result = add_new_friend(@person2, "Scrappy-Doo")
  ...
  def test_total_sum_of_everyones_money
    result = total_of_everyones_money(@people)
